...
public class CheatPlayerManualAStarWrapper extends AIPlayerWrapper {
    ...
    public CheatPlayerManualAStarWrapper(Class<? extends AbstractAStar> aStarClass, 
                    ...
                    throws Exception {
        super((Class<? extends AbstractAStar<AbstractBranchingPlayer>>) aStarClass, player, cost, heuristic, isGoal);
    }
