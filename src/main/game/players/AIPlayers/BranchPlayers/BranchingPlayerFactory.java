...
public class BranchingPlayerFactory implements Buildable<AbstractBranchingPlayer> {// TODO complete. Make static?
    ...
    public BranchingPlayerFactory(Class<? extends AbstractBranchingPlayer> clazz, Game game, Grid grid, TileBag bag) throws Exception {
        // get constructor for the unknown extending class and inject player dependencies
        constructor = clazz.getDeclaredConstructor(new Class<?>[] {Game.class, Grid.class, TileBag.class}); 
