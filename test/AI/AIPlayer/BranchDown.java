...
class BranchDown {
    static Function <AIPlayerParallel, Set<AIPlayerParallel>> branchDown; // this will branch only down and add forward branches for these tests
    ...
    void singleBranchTilesBeforeTest() {
        ...
        Set<AIPlayerParallel> nextPlayers = branchDown.apply(player);
