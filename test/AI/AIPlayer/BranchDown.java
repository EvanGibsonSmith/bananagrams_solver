...
class BranchDown {
    static Function <AIPlayerSerial, Set<AIPlayerSerial>> branchDown; // this will branch only down and add forward branches for these tests
    ...
    void singleBranchTilesBeforeTest() {
        ...
        Set<AIPlayerSerial> nextPlayers = branchDown.apply(player);
